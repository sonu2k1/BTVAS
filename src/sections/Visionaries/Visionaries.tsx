  ...
  return (
    ...
    >
      ...
      <div className="visionaries-heading site-inner-root" style={{ width: "100%", maxWidth: "1280px" }}>
        ...
        >
          <span style={{ textDecoration: "underline", textDecorationColor: "#FF4880", textUnderlineOffset: "8px", textDecorationThickness: "4px", textDecorationSkipInk: "none" }}>The Visionaries </span>{" "}
